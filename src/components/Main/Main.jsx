...
const Main = () => {
  const prompt1 = "Who are Huawei";
  const prompt2 = "What is the history of Huawei";
  const prompt3 = "Huawei impact on tech industry";
  const prompt4 = "What is Quantum Computing";
      ...
      {!showResult ? (
        <>
          <div className="greet">
              ...
              <p>Welcome to the Huawei ChatBot</p>
          </div>
          <div className="cards">
